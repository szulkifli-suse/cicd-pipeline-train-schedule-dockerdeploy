            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'webserver_login', usernameVariable: 'USERNAME', passwordVariable: 'USERPASS')]) {
                    script {
                        ...
                        /*sh "ssh -o StrictHostKeyChecking=no -i /home/centos/jenkin.cer $USERNAME@darkjenkins.ddns.net \"docker pull darkwunan/train-schedule:${env.BUILD_NUMBER}\""*/
                        try {
                            ...
                            /*sh "ssh -o StrictHostKeyChecking=no -i /home/centos/jenkin.cer $USERNAME@darkjenkins.ddns.net \"docker stop train-schedule\""
                            sh "ssh -o StrictHostKeyChecking=no -i /home/centos/jenkin.cer $USERNAME@darkjenkins.ddns.net \"docker rm train-schedule\""*/
                        } catch (err) {
                        ...
                        /*sh "sssh -o StrictHostKeyChecking=no -i /home/centos/jenkin.cer $USERNAME@darkjenkins.ddns.net \"docker run --restart always --name train-schedule -p 8080:8080 -d darkwunan/train-schedule:${env.BUILD_NUMBER}\""*/
                    }
                }
            }
        }
